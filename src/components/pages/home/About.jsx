...
const About = () => {
    ...
    return (
        <div className="my-10 py-5 md:my-20 px-8 lg:px-0 image2 opacity-80" data-aos="zoom-in">
            <div className="text-center">
                <section>
                    <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
                        <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 opacity-70 rounded-lg p-8 md:p-12 mb-8">
                            ...
                            <h1 className="text-gray-900 dark:text-white text-3xl md:text-5xl font-extrabold mb-2">University | Definition, Origin, History, & Facts</h1>
                            <p className="text-lg font-normal text-gray-500 dark:text-gray-400 mb-6">SAccelerate your skills with our 4+1 Program and get a Graduate Degree in a year. Learn to work with the latest applications and technology. international@dsu.edu.</p>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            <div className="bg-gray-50 dark:bg-gray-800 border opacity-60 border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12">
                                ...
                                <h2 className="text-gray-900 dark:text-white text-3xl font-extrabold mb-2">Welcome to University of Dhaka. On the first day of July 1921 </h2>
                                <p className="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4">The Henry Lee Professor of Economics at Harvard University has been awarded the Nobel Memorial Prize in Economic Sciences for her work identifying drivers of gender differences in the labor market, the Royal Swedish Academy of Sciences announced.</p>
                            ...
                            <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 opacity-75 dark:border-gray-700 rounded-lg p-8 md:p-12">
